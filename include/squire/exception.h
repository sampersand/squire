...
SQ_NORETURN void sq_internal_throw_value(sq_value value) SQ_COLD;
SQ_NORETURN void sq_throw2(struct sq_form *form, const char *fmt, ...)
	SQ_ATTR_PRINTF(2, 3) SQ_COLD SQ_NONNULL;

#define sq_throw_value(...) (sq_internal_throw_value(__VA_ARGS__),SQ_UNREACHABLE) // a hack for c99
